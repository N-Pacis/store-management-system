            ...
            if(!$con){
                ...
                if(!$selectResult){
                    ...
                    if(!$selectUserResult){
                        ...
                        $insertQuery = "INSERT INTO stk_outgoing(quantity,productId,userId) values('$qty','$pId','$uid')";
                        $result = mysqli_query($con,$insertQuery);
                        if(!$result){
                            echo "<div class='error-div'><i class='far fa-times-circle'></i>Unable to register outgoing product due to.".mysqli_error($con)."</div>";
                        }
                        else{
