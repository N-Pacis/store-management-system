...
<body>
    ...
    if (!$con) {
        ...
        $selectQuery = "SELECT * FROM stk_inventory where inventory_id=$record_id";
    ...
    ?>
            <form action="incomingProductUpdate.php" method="post">
                <h3>Incoming Product Update</h3>
                    <input type="hidden" id="inventory" name="inventoryId" value='<?php echo $rowSelect["inventory_id"] ?>' readonly>
