...
<body>
   <?php 
       ...
       if(!$con){
           ...
           $selectQuery = "SELECT sum(inv.quantity),prod.product_Name from stk_inventory inv INNER JOIN stk_products prod ON inv.productId=prod.productId GROUP BY inv.productId";
